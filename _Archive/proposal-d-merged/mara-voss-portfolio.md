...
<!-- bm:block id=hero kind=image preset=hero focal={"x":0.5,"y":0.32"} label="Cover ridgeline" -->
![Ridgeline at first light above the Dolomites](images/dolomites.svg)
...
<!-- bm:columns id=about-split weights=[2,1] label="Story and details" -->
<!-- bm:col label="About the work" -->
## A slow practice
...
<!-- bm:block id=selected-prints kind=image preset=gallery label="Selected work" -->
- ![Ridgeline above the Dolomites](images/dolomites.svg)
- ![A coastal cliff above a Norwegian fjord](images/fjord.svg)
- ![A glacier calving into a still lake](images/glacier.svg)
- ![Low fog moving over a highland moor](images/moor.svg)
...
<!-- bm:section id=exhibition preset=dark label="Current exhibition" -->
<!-- bm:var name=seconds value=18 -->
...
<!-- bm:block id=exhibition-note preset=note label="Exhibition note" -->
### Note: the print wall
...
<!-- bm:block id=exhibition-warning preset=warning label="Edition warning" -->
...
<!-- bm:block id=colophon-note preset=note label="Contact" -->
### Contact the studio
